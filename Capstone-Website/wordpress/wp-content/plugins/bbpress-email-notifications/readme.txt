...
1. Upload the `bbpress-email-notifications` folder and its contents to your `/wp-content/plugins/` directory.
1. Activate the "bbPress Email Notifications" plugin in your WordPress Plugins administration interface.

== Changelog ==

= 0.3 =
* Remove loader; just load the class.
...
= 0.3 =
* Fix missing form in user profile.
